...
/**
 * Calculate the ange between two vectors.
 *
 * @param v1 the first vec to find the angle between
 * @param v2 the second vec to find the angle between
 * @return a double representing the vector's difference in angle
 */
